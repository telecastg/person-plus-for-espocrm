...
define('person-plus:views/fields/person-name-plus', 'views/fields/varchar', function (Dep) {
    ...
    return Dep.extend({
        ...
        editTemplateFirstMiddleLastMotherMaiden: 'person-plus:fields/person-name-plus/edit-first-middle-last-mother-maiden',

        editTemplateFirstLastMotherMaiden: 'person-plus:fields/person-name-plus/edit-first-last-mother-maiden',

        editTemplateLastMotherMaidenFirstMiddle: 'person-plus:fields/person-name-plus/edit-last-mother-maiden-first-middle',
        ...
        data: function () {
            ...
            data.motherMaidenValue = this.model.get(this.motherMaidenField);
            ...
            if (this.mode === 'edit') {
                ...
                data.motherMaidenMaxLength = this.model.getFieldParam(this.motherMaidenField, 'maxLength');
            }
        ...
        setup: function () {
            ...
            this.motherMaidenField = 'motherMaiden' + ucName;
        },
        ...
        afterRender: function () {
            ...
            if (this.mode == 'edit') {
                ...
                if (this.formatHasMotherMaiden()) {
                    this.$motherMaiden = this.$el.find('[data-name="' + this.motherMaidenField + '"]');
                }
                ...
                if(this.$middle) {
                    this.$middle.on('change', function () {
                        this.trigger('change');
                    }.bind(this));                    
                }
                if(this.$motherMaiden) {
                    this.$motherMaiden.on('change', function () {
                        this.trigger('change');
                    }.bind(this));                    
                }                
            }
        ...
        getFormattedValue: function () {
            ...
            var motherMaiden = this.model.get(this.motherMaidenField);
            ...
            switch (format) {
                ...
                case 'firstMiddleLastMotherMaiden':
                    ...
                    if (middle) arr.push(middle);
                    if (last) arr.push(last);
                    if (motherMaiden) arr.push(motherMaiden);
                    value = arr.join(' ');
                    break;
        ...
        formatHasMiddle: function () {
            ...
            return format === 'firstMiddleLast' || format === 'lastFirstMiddle' || format === 'firstMiddleLastMotherMaiden' || format === 'lastMotherMaidenFirstMiddle';
        },

        formatHasMotherMaiden: function () {
            var format = this.getFormat();

            return format === 'firstMiddleLastMotherMaiden' || format === 'lastMotherMaidenFirstMiddle' || 'firstLastMotherMaiden';
        },
        ...
        fetch: function (form) {
            ...
            if (this.formatHasMotherMaiden()) {
                data[this.motherMaidenField] = this.$motherMaiden.val().trim() || null;
            }
