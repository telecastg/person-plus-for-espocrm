...
namespace Espo\Modules\PersonPlus\Entities;

use Espo\Core\Utils\Config;

class PersonPlus extends \Espo\Core\ORM\Entity
{
    ...
    public function _setMotherMaidenName($value)
    {
        $this->setValue('motherMaidenName', $value);
