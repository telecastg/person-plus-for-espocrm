...
namespace Espo\Modules\PersonPlus\Core\Loaders;

class EntityManagerHelper extends \Espo\Core\Loaders\Base
{
    public function load()
    {
$GLOBALS['log']->warning("Espo\Modules\PersonPlus\Core\Loaders\EntityManagerHelper loaded");
        return new \Espo\Modules\PersonPlus\Helpers\PersonPlusHelper(
